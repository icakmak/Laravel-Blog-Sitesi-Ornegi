...
@section('title',$category->name) {{-- header.blade de title alanında yield tanımlıyoruz ve o yield bizim başlık alanımız oluyor --}}
...
<div class="col-md-9 col-xl-7">
    ...
    @else
        <div class="alert alert-success" role="alert">
            {{$category->name}} Kategorisinde Henüz Bir yazı Eklenmemiş.Daha Sonra Tekrar Kontrol Edebilirsiniz.
        </div>
    @endif
